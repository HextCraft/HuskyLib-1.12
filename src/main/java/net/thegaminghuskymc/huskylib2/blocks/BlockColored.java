...
public class BlockColored extends BlockMod implements IBlockColorProvider, IModBlock {

    public final EnumDyeColor color;
    private String modid;

    public BlockColored(String modid, String name, EnumDyeColor color) {
        super(Material.ROCK, modid, name + "_" + color.getName());
        this.color = color;
        this.modid = modid;
    }
