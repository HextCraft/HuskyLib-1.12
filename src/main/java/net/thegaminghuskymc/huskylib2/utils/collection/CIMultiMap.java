...
//TODO: Clean up and improve this messy pile of garbage
public class CIMultiMap<T> extends AbstractSet<T> {
    ...
    public CIMultiMap(Class<T> baseClassIn)
    {
    ...
    public <S> Iterable<S> getByClass(final Class<S> clazz)
    {
        return new Iterable<S>()
        {
            ...
            {
                List<T> list = (List)CIMultiMap.this.map.get(CIMultiMap.this.initializeClassLookup(clazz));
