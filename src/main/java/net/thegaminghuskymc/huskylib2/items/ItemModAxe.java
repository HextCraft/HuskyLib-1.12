...
public abstract class ItemModAxe extends ItemModTool {
    ...
    public ItemModAxe(float attckDmg, float attckSpd, Item.ToolMaterial material, String name, String modid, String... variants) {
        super(attckDmg, attckSpd, material, EFFECTIVE_ON, name, modid, variants);
